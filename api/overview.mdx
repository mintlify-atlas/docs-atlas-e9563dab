...
Import the `AppRouter` type from `@slides/api` to get full end-to-end type safety. You never need to write the procedure name as a string — the client infers it from the type.
